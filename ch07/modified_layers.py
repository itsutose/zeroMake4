...
# =============================================================================
class Linear(Layer):
    def __init__(self, out_size, nobias=False, dtype=np.float32, in_size=None, name = None):
        super().__init__()
        ...
        if name == None:
            ...
            self.W = Parameter(None, name = name)
        ...
        if nobias:
            ...
            if name == None:
                ...
                self.b = Parameter(np.zeros(out_size, dtype=dtype), name= name)
